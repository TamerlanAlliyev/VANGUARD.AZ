...
namespace Vanguard.Migrations
{
    ...
    [Migration("20240606175837_HomeSlider_up_4")]
    partial class HomeSlider_up_4
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Vanguard.Models.HomeSlider", b =>
                {
                    b.HasOne("Vanguard.Models.Image", "Image")
                        .WithOne("HomeSlider")
                        .HasForeignKey("Vanguard.Models.HomeSlider", "ImageId");

                    b.HasOne("Vanguard.Models.Tag", "Tag")
                        .WithOne("HomeSlider")
                        .HasForeignKey("Vanguard.Models.HomeSlider", "TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
